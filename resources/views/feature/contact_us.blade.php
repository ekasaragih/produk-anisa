        ...
        <div class="page p-8 bg-white rounded-2xl shadow-lg border border-gray-200 animate-fade-in">
            ...
            <div id="accordion-collapse" data-accordion="collapse">
                ...
                <h2 id="accordion-collapse-heading-1">
                    <button type="button"
                        class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-black border border-b-0 border-gray-200 rounded-t focus:ring-4 focus:ring-gray-200 bg-white dark:bg-white text-black dark:hover:bg-white gap-3"
