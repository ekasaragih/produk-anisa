        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 mt-4">
            <div class="bg-white shadow-md rounded-lg p-4 border-l-4 border-green-500 flex flex-col h-full">
                ...
                <button data-modal-target="add-hb-record-modal" data-modal-toggle="add-hb-record-modal"
                    class="mt-auto bg-green-500 text-white px-4 py-2 rounded-md self-start text-left">
                    Masukkan Data HB 🩺
                </button>
            </div>
            ...
            <div class="bg-white shadow-md rounded-lg p-4 border-l-4 border-purple-500 flex flex-col h-full">
                ...
                <button class="mt-auto bg-purple-500 text-white px-4 py-2 rounded-md self-start text-left"
            ...
            <div class="bg-white shadow-md rounded-lg p-4 border-l-4 border-red-500 flex flex-col h-full">
                ...
                <a href="/contact_us"
                    class="mt-auto bg-red-500 text-white px-4 py-2 rounded-md self-start text-left">Hubungi
                    Medis 📞</a>
            </div>
        </div>
    </div>
