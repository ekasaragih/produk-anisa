            ...
            <div class="h-full overflow-y-auto space-y-8">
                ...
                <div class="p-6 bg-white border border-blue-300 rounded-2xl shadow-sm">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6">
                        ...
                        <div class="p-4 bg-white shadow-md rounded-xl text-center">
                            <img src="{{ asset('assets/wajah_pucat.jpg') }}" class="mx-auto" width="100"
                                height="100" />
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6">
                        ...
                        <div class="p-4 bg-white shadow-md rounded-xl text-center">
                            <img src="{{ asset('assets/konjungtiva_pucat.jpg') }}" class="mx-auto" width="100"
                                height="100" />
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6">
                        ...
                        <div class="p-4 bg-white shadow-md rounded-xl text-center">
                            <img src="{{ asset('assets/kulit_pucat.jpg') }}" class="mx-auto" width="100"
                                height="100" />
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-6">
                        ...
                        <div class="p-4 bg-white shadow-md rounded-xl text-center">
                            <img src="{{ asset('assets/kuku_pucat.jpg') }}" class="mx-auto" width="100" height="100" />
