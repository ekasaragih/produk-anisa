            ...
            <div class="h-full overflow-y-auto space-y-8">
                ...
                <div class="p-6 bg-white border border-blue-300 rounded-2xl shadow-sm">
                    ...
                    <div class="flex justify-center">
                        <div
                            class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6 mt-6 place-items-center">
                            <div class="p-4 bg-white shadow-md rounded-xl flex flex-col items-center text-center">
                                <img src="{{ asset('assets/wajah_tdk_pucat.jpg') }}" class="w-24 h-24 object-cover" />
                                <p class="mt-2 text-blue-700">Wajah tidak pucat</p>
                            </div>
                            <div class="p-4 bg-white shadow-md rounded-xl flex flex-col items-center text-center">
                                <img src="{{ asset('assets/wajah_pucat.jpg') }}" class="w-24 h-24 object-cover" />
                                <p class="mt-2 text-red-500">Wajah pucat</p>
                            </div>
                            <div class="p-4 bg-white shadow-md rounded-xl flex flex-col items-center text-center">
                                <img src="{{ asset('assets/konjungtiva_merah_muda.jpg') }}"
                                    class="w-24 h-24 object-cover" />
                                <p class="mt-2 text-blue-700">Konjungtiva Merah Muda</p>
                            </div>
                            <div class="p-4 bg-white shadow-md rounded-xl flex flex-col items-center text-center">
                                <img src="{{ asset('assets/konjungtiva_pucat.jpg') }}" class="w-24 h-24 object-cover" />
                                <p class="mt-2 text-red-500">Konjungtiva Tampak Pucat</p>
                            </div>
                            <div class="p-4 bg-white shadow-md rounded-xl flex flex-col items-center text-center">
                                <img src="{{ asset('assets/kulit_tidak_pucat.jpg') }}" class="w-24 h-24 object-cover" />
                                <p class="mt-2 text-blue-700">Kulit Tidak Pucat</p>
                            </div>
                            <div class="p-4 bg-white shadow-md rounded-xl flex flex-col items-center text-center">
                                <img src="{{ asset('assets/kulit_pucat.jpg') }}" class="w-24 h-24 object-cover" />
                                <p class="mt-2 text-red-500">Kulit Pucat</p>
                            </div>
                            <div class="p-4 bg-white shadow-md rounded-xl flex flex-col items-center text-center">
                                <img src="{{ asset('assets/kuku_kemerahan.jpg') }}" class="w-24 h-24 object-cover" />
                                <p class="mt-2 text-blue-700">Kuku Kemerahan</p>
                            </div>
                            <div class="p-4 bg-white shadow-md rounded-xl flex flex-col items-center text-center">
                                <img src="{{ asset('assets/kuku_pucat.jpg') }}" class="w-24 h-24 object-cover" />
                ...
                <div class="p-6 bg-white border border-blue-300 rounded-2xl shadow-sm">
                    ...
                    <div class="flex justify-center items-center mt-6">
                        <div class="p-4 bg-white shadow-md rounded-xl text-center">
                            <img src="{{ asset('assets/tablet_FE.jpg') }}" class="mx-auto" width="150" height="150" />
