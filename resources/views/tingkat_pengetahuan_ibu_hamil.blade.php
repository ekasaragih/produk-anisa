...
<div class="container mx-auto pb-8 px-4 min-h-screen">
    ...
    <div class="page p-8 bg-white rounded-2xl shadow-lg border border-gray-200 animate-fade-in">
        <form id="quizForm">
            ...
            <button type="button" onclick="checkAnswers()" class="mt-4 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-700">Kirim Jawaban</button>
        </form>
        ...
        <div id="result" class="result">
            ...
            <ul>
                <li>1. Mengonsumsi makanan kaya zat besi seperti daging merah, hati, bayam, dan kacang-kacangan.</li>
